...
class StandardRoomUI extends StatefulWidget {
  final String roomType;
  final int userId; // เพิ่มตัวแปร userId เพื่อรับค่า memId

  const StandardRoomUI({Key? key, required this.roomType, required this.userId}) : super(key: key);

  @override
  _StandardRoomUIState createState() => _StandardRoomUIState();
}

class _StandardRoomUIState extends State<StandardRoomUI> {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Image.asset('assets/images/standard.jpg'),
              ),
              ElevatedButton(
                onPressed: () {
